...
public class RaceAbilityManager {
	...
	public RaceAbilityManager(PwingRaces plugin) {
		this.plugin = plugin;
	...
	public RaceAbility getAbility(String key, String requirement, String configPath, YamlConfiguration config) {
		...
		try {
			Constructor<? extends RaceAbility> abilityConstructor = abilityClass.getConstructor(PwingRaces.class, String.class, String.class, YamlConfiguration.class, String.class);
