...
import net.pwing.races.events.RaceReclaimItemsEvent;
import net.pwing.races.events.RaceReclaimSkillpointsEvent;
...
public class RaceMenu {
	...
	public RaceMenu(PwingRaces plugin, String name, int slots, boolean glassFilled) {
		this.plugin = plugin;
