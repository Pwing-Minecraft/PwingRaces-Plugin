...
public abstract class RaceAbility implements Listener {
	...
	public RaceAbility(PwingRaces plugin, String internalName, String configPath, YamlConfiguration config, String requirement) {
		this.plugin = plugin;
	...
	public void setOverrideDefaultActuin(boolean overrideDefaultAction) {
